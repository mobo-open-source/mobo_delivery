...
<div>
  <img src="assets/images/git/picking.png" width="200" height="500" style="margin:8px;" />
  <img src="assets/images/git/map.png" width="200" height="500" style="margin:8px;" />
  <img src="assets/images/git/return.png" width="200" height="500" style="margin:8px;" />
  <img src="assets/images/git/offline.png" width="200" height="500" style="margin:8px;" />
</div>
...
4. **Set up environment files**
   ...
   **`.env`** — Set a strong 32-character encryption key:
   ```
   ENCRYPTION_KEY="your_32_character_secret_key_here"
   ```

   **`android/local.properties`** — Add your Google Maps API key (requires Maps SDK for Android + Directions API enabled in Google Cloud Console):
   ```
   ...
   The key is injected into `AndroidManifest.xml` automatically via Gradle — do not hardcode it there.

   **iOS** — Open `ios/Runner/AppDelegate.swift` and register your key:
   ```swift
