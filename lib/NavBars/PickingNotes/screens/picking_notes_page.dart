          ...
          children: [
            Column(
              children: [
                ...
                // Filter/group status + pagination controls
                Padding(
                ...
                _isLoading
                    ...
                    ? Expanded(
                        child: EmptyState(
                          ...
                          actionLabel: (hasFilters || hasGroupBy || _searchController.text.isNotEmpty)
                              ? 'Clear All Filters'
                              : null,
                    ...
                    ? Expanded(
                        child: ErrorStateWidget(
                          ...
                          message: 'Unable to load picking notes. Please try again.',
                          onRetry: () async {
            ...
            if (pageLoading) const LoadingOverlay(),
          ],
        ),
      ),
    );
