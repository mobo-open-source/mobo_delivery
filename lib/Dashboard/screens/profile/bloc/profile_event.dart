...
/// Triggers loading of all available countries for address selection.
class LoadCountries extends ProfileEvent {}

/// Triggers loading of states for a specific country.
class LoadStates extends ProfileEvent {
  final int countryId;
